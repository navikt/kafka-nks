...
import no.nav.kafka.dialog.metrics.Prometheus.registerCounter
import no.nav.kafka.dialog.metrics.Prometheus.registerGauge
import no.nav.kafka.dialog.metrics.Prometheus.registerLabelGauge
